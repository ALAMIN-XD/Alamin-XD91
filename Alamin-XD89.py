...
\033[1;93m  
    ...
    鈹� [鉁揮 AUTHOR   : ALAMIN            鈹�
    鈹� [鉁揮 GITHUB   :  Alamin-XD89       鈹�
    鈹� [鉁揮 WHATSAPP : 01915935712        鈹�
    鈹� [鉁揮 POWER BY : \x1b[1;32mALAMIN\x1b[1;97m            鈹�
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/Termux.User.Tera.Next.Abbu')
		else:
			Main()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[ALAMIN馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
